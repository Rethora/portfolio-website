---
title: URL Recipe Scraper
description: A lightweight recipe scraper that parses recipe data from many popular recipe websites that use application ld json format by url or html
date: "2024-06-06"
dateFrom: "2024-06-05"
dateTo: "2024-06-06"
published: true
repository: https://github.com/Rethora/url-recipe-scraper
url: https://www.npmjs.com/package/@rethora/url-recipe-scraper
images:
  - "/images/projects/recipe-scraper/allrecipes.png"
technologies:
  - "typescript"
  - "npm"
---
...
This package allows you to scrape recipe data from almost any recipe website by leveraging the widely adopted application/ld+json format to extract recipe information with reliable schema-based typing, ensuring consistent and developer-friendly output.
...
getRecipeData("https://example/recipes/creamy-courgette-potato-bake").then(
  (recipe) => {
    console.log(recipe);
  }
);
